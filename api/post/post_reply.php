...
if(
    ...
    if($earringpost->post_reply()){
  
        // set response code - 201 created
        http_response_code(201);
  
        // tell the user
        echo json_encode(array("message" => "Post comment was created."));
    }
    ...
    // if unable to create the earringpost, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to create post comment."));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to create Post comment. Data is incomplete."));
}
?>